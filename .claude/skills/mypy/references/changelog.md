...
### Disjoint Base Classes (@disjoint\_base, PEP 800)
...
* Fix crash when enable\_error\_code in pyproject.toml has wrong type (wyattscarpenter, PR [19494](https://github.com/python/mypy/pull/19494))
...
* Update “common issues” (reveal\_type/reveal\_locals; note on orjson) (wyattscarpenter, PR [19059](https://github.com/python/mypy/pull/19059), [19058](https://github.com/python/mypy/pull/19058))
...
* Derive .c file name from full module name if using multi\_file (Jukka Lehtosalo, PR [19278](https://github.com/python/mypy/pull/19278))
...
Without the new flag, mypy only supports inferring optional types (`X | None`) from multiple assignments, but now mypy can infer arbitrary
union types.
...
* `pythoncapi_compat`: don’t define Py\_NULL if it is already defined (Michael R. Crusoe, PR [18699](https://github.com/python/mypy/pull/18699))
...
(PR [mypy\_mypyc-wheels#76](https://github.com/mypyc/mypy_mypyc-wheels/pull/76),
PR [mypy\_mypyc-wheels#89](https://github.com/mypyc/mypy_mypyc-wheels/pull/89)).
...
* Use public PyGen\_GetCode instead of vendored implementation (Marc Mueller, PR [17931](https://github.com/python/mypy/pull/17931))
...
* Set default strict\_optional state to True (Shantanu, PR [18198](https://github.com/python/mypy/pull/18198))
...
* Move long\_description metadata to pyproject.toml (Marc Mueller, PR [18172](https://github.com/python/mypy/pull/18172))
...
* Clean up new\_semantic\_analyzer config (Shantanu, PR [18071](https://github.com/python/mypy/pull/18071))
...
* Make is\_sub\_path faster (Shantanu, PR [17962](https://github.com/python/mypy/pull/17962))
...
* Optimize TYPE\_CHECKING to False at Runtime (Srinivas Lade, PR [16263](https://github.com/python/mypy/pull/16263))
...
* Fix false positives related to type[] (sterliakov, PR [14756](https://github.com/python/mypy/pull/14756))
